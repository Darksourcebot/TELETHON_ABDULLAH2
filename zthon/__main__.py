...
LOGS = logging.getLogger("سورس عبد الاله")
...
try:
    LOGS.info("✧ بـدء تنزيـل عبد الاله ✧")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["Help_Leader","Help_Tele_Leader","leader_VIAS","PP_NL","FOR_Abdullah ","PP_NL","Help_Leader","Help_Tele_Leader","leader_VIAS","PP_NL","FOR_Abdullah "]
    ...
    print(f"⌔┊تـم تنصيـب عبد الاله . . بنجـاح ✓ \n⌔┊لـ إظهـار الاوامـر ارسـل (.الاوامر)")
    await verifyLoggerGroup()
