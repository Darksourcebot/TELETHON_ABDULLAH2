...
ZelzalDV_cmd = (
    "𓆩 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 - اوامر بوت استخراج الجلسات](t.me/PP_NL) 𓆪\n\n"
    "⪼ بوت استخراج جلسات الخاص بسورس عبد الاله \n"
    "⪼(@gen_leader_src_bot)n"
    "⪼برعاية المطور عبد الاله  \n" 
    "⪼ ⪼ برعاية المطور عبد الاله \n"
    "\n𓆩 [𐇮 • 𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 ™⤶](t.me/h_v_i) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت عبد الاله انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت عبد الاله انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
