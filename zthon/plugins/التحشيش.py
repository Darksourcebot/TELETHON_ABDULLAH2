...
zel_dev = (5992366190, 5992366190, 5992366190)
...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/PP_NL) 🗑♻️𓆪\n**𓍹━─━─━─━─𝗟𝗘𝗮𝗗𝗲𝗥─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 5992366190 or user.id == 5992366190 or user.id == 5992366190:
...
ZelzalTHS_cmd = (
    "𓆩 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/PP_NL) 𓆪\n\n"
