...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت عبد الاله"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝗟𝗘𝗮𝗗𝗲𝗥 ─┄─┄─┄─⋆"
zed_dev = (5992366190, 5992366190, 5449190469)
zel_dev = (5992366190, 5992366190)
zelzal = (5992366190, 5992366190, 5449190469)
