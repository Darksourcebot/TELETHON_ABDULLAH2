    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/8339c0d3a0025c03ee731.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس عبد الاله الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗦َِ𝗼َِ𝗨َِ𝗿َِ𝗖َِ𝗲 َِ𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇", "https://t.me/PP_NL"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بـوت عبد الاله المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
...
zthon = {"@PP_NL", "@PP_NL", "@PP_NL", "@PP_NL", "@PP_NL", "@PP_NL"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "كـروب السجـل عبد الاله", zedub, Config.TG_BOT_USERNAME, descript, photozed
