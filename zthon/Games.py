...
R = [
    ...
    "**-** مطور السورس **⪼ [Monzer ⌁ ](t.me/Z_X_Z_B)   \n"
    "**-** قناة السورس **⪼ [𝗦𝗢𝗨𝗥𝗖𝗘 ](t.me/V_P_N_8)   "
]

@zedub.on(admin_cmd(pattern="الالعاب$"))
...
@zedub.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@zedub.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(Jepthon_5erok))

    
@zedub.on(admin_cmd(pattern="اذكار عشر$"))    
...
@zedub.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
...
@zedub.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
